...
const form = useForm({
    ...
    type: props.collection.type || 'group',
});

const selectedType = ref(props.collection.type || 'group');
...
const submit = () => {
    form.put(route('collections.edit.page1.update', { collection: props.collection.id }));
};
    ...
    <body class="font-body text-on-surface min-h-screen pb-32">
        ...
        <header class="fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-100">
            <div class="flex items-center px-4 py-4 w-full max-w-7xl mx-auto relative">
                ...
                <h1 class="absolute left-1/2 -translate-x-1/2 font-semibold text-gray-800 text-[18px]">Edit Collection</h1>
