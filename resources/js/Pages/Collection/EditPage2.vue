...
const submit = () => {
    ...
    form.put(route('collections.update', { collection: props.collection.id }), {
        data: data,
    });
};
...
<template>
    <Head title="Edit Collection - Step 2" />
    <body class="font-body text-on-surface min-h-screen flex flex-col">
        ...
        <nav class="bg-white border-b border-slate-50 top-0 sticky z-40 flex justify-between items-center w-full px-4 py-4">
            ...
            <h1 class="font-semibold text-[17px] text-slate-800">Edit Collection</h1>
        ...
        <div class="fixed bottom-0 left-0 w-full p-6 bg-white/80 backdrop-blur-sm z-40">
            <div class="max-w-md mx-auto">
                <button
                    ...
                    @click="submit"
                >
                    <span class="text-[18px]">Update Collection</span>
